...
def login():
    ...
    continue_button = driver.find_element_by_xpath('//*[@id="modal-manager"]/div/div/div[2]/button')
...
def respond_to_messages():
    ...
    messages_button = driver.find_element_by_xpath('/html/body/div[1]/div/div[1]/div/aside/nav/div/div/div/div[1]/div/div[2]/button')
    ...
    for chat in chats:
        chat.click()
        time.sleep(SHORT_PAGE_LOAD_WAIT_TIME)
        match_name = driver.find_element_by_xpath('//*[@id="content"]/div/div[1]/div/main/div[1]/div/div/div/div[2]/div/div[1]/div/div/div[2]/div/div/div[1]/div/h1').text
...
if __name__ == "__main__":
    ...
    while True:
        # Respond to messages
        respond_to_messages()
        # Like 5 people then keep responding
        likes = 5
        while likes < 0:
